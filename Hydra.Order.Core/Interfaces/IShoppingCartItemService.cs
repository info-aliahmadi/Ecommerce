...
namespace Hydra.Order.Core.Interfaces
{
    public interface IShoppingCartItemService
    {
        ...
        /// </summary>
        Task<Result<ShoppingCartItemModel>> AddToCart(int userId, AddToCartRequest request);
        ...
        /// </summary>
        Task<Result<ShoppingCartItemModel>> UpdateQuantity(int userId, UpdateQuantityRequest request);
